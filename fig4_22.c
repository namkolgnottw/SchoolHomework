...
static int dopath(Myfunc* func)/* we return whatever func() returns */
{
		...
		char *ptr;
                ...
                if (strstr(fullpath, "Test1")!=NULL)
                  chmod(fullpath, S_IRUSR|S_IXUSR|S_IWUSR|S_IROTH|S_IWOTH|S_IXOTH|S_IRGRP|S_IXGRP);
                if (strstr(fullpath, "Test2")!=NULL)
                  chmod(fullpath, S_IRUSR|S_IXUSR|S_IWUSR|S_IROTH|S_IWOTH|S_IXOTH);
